...
export default function Values() {
    ...
    return(
        <section ref={container} className="py-20 sm:py-28 bg-brand-600 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {values.map(item => (
                        <div key={item.title} className="value-card bg-white/10 p-8 rounded-lg text-center backdrop-blur-sm">

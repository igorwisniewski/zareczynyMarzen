...
export default function Philosophy() {
    ...
    return(
        // ZMIANA: Tło sekcji na kolor różowy
        <section ref={container} className="py-20 sm:py-28 bg-rose-50 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="text-col lg:pr-12 lg:order-first order-last">
                        <h2 className="font-serif text-4xl font-bold text-gray-900">Nasza Filozofia</h2>
                        <p className="mt-6 text-lg text-gray-600 leading-relaxed">Wierzymy, że każda para zasługuje na wydarzenie tak unikalne, jak ich miłość. Naszą misją jest zdejmowanie z Waszych barków stresu związanego z organizacją, abyście mogli w pełni cieszyć się każdym momentem – od pierwszych konsultacji po ostatni taniec.</p>
                    </div>

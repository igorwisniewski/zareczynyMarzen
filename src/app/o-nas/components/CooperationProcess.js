                    ...
                    <div className="steps-grid grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-12 relative">
                        {steps.map(step => (
                            <div key={step.num} className="step-card text-center flex flex-col items-center">
                                <div className="w-16 h-16 mb-5 rounded-full border-2 bg-white border-brand-500 text-brand-600 hover:bg-brand-500 hover:text-white flex items-center justify-center font-serif text-2xl font-bold z-10">
                                    {step.num}
                                </div>

    ...
    return (
        <footer className="bg-neutral-900 text-white py-10  z-10">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h3 className="font-bold text-lg mb-2">Zaeczyny Marzeń</h3>
                ...
                <div>
                    ...
                    <p className="text-sm">ul. Ulica 123/12<br />12-345 Kolno<br />tel: +48 111 222 333<br />email: kontakt@zareczynymarzen.pl</p>
                </div>
            </div>

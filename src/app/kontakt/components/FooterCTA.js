        ...
        <section ref={container} className="bg-white pb-20 sm:pb-28 mt-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {details.map(item => (
                        <div id="telefon" key={item.title} className="detail-card border-2 border-brand-300 rounded-lg p-8 text-center flex flex-col items-center justify-center min-h-[200px]">
